    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        public class Mytask extends AsyncTask<String, Void, ArrayList<String[]>> {
            ...
            protected ArrayList<String[]> doInBackground(String... params) {
                ...
                try {
                    URL mySite = new URL("http://localhost:8080/phpmyadmin/sql.php?server=1&db=kino&table=films&pos=0" + params[0]);
...
//                        sb.append("\r\n : " +value);
    ...
    class ClAdapter extends BaseAdapter implements com.example.p070.ClAdapter {
        Context ctx;
